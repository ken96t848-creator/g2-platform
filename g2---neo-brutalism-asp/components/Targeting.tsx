      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-[#F8F9FA] p-8 md:p-12 neo-border neo-shadow fade-in-up">
            ...
            <button className="neo-button bg-black text-white px-8 py-4 font-black uppercase w-full tracking-widest text-xs md:text-sm">
              広告主登録
            </button>
          </div>
          ...
          <div className="bg-white p-8 md:p-12 neo-border neo-shadow-blue fade-in-up" style={{ transitionDelay: '0.2s' }}>
            ...
            <button className="neo-button bg-[var(--blue)] text-white px-8 py-4 font-black uppercase w-full tracking-widest text-xs md:text-sm">
              パートナー登録
            </button>
          </div>
