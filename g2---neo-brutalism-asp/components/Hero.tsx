  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-24 md:pt-32 overflow-hidden bg-[#F2F2F2]">
      ...
      <div className="px-6 md:px-10 flex flex-col sm:flex-row gap-4 md:gap-6 fade-in-up" style={{ transitionDelay: '0.3s' }}>
        <button className="neo-button bg-black text-white px-8 md:px-10 py-4 md:py-5 text-base md:text-lg font-black uppercase tracking-tighter w-full sm:w-auto">
          ADVERTISER
        </button>
        <button className="neo-button bg-white text-black px-8 md:px-10 py-4 md:py-5 text-base md:text-lg font-black uppercase tracking-tighter w-full sm:w-auto">
          AFFILIATE
        </button>
      </div>
    </section>
